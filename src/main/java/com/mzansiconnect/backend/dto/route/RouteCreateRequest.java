...
public class RouteCreateRequest {
    ...
    @Size(
            max = 60,
            message = "Route code cannot exceed 60 characters"
    )
    ...
    @Size(
            max = 200,
            message = "Route name cannot exceed 200 characters"
    )
    ...
    @Size(
            max = 150,
            message = "Taxi sign cannot exceed 150 characters"
    )
    ...
    @Min(
            value = 0,
            message = "Estimated waiting time cannot be negative"
    )
    @Max(
            value = 1440,
